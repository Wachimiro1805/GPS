...
import {getDenuncias, putDenuncias, getDenunciasBySchool, deleteDenuncia, updateDenuncia, getEscuelasMS, getEscuelaS, getDenunciasVS, getDenunciasVF, getDenunciasVP, getDenunciasVPV} from '../modelos/Denuncia.model.js';
const router = Router();
