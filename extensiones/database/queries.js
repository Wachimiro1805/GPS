export const queries = {
    ...
    getEscuelasMS: "select count(NIVELESCUELA) as cant from ESCUELAS where NIVELESCUELA = 'Media S';",
    getEscuelaS: "select count(NIVELESCUELA) as cant from ESCUELAS where NIVELESCUELA = 'Superior';",
